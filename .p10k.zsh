# Generated by Powerlevel10k configuration wizard on 2021-04-03 at 05:53 CST.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND='#4FCFFF'
  # Custom icon.
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_FVM_VISUAL_IDENTIFIER_EXPANSION='f'
